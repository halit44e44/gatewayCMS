...
<header>
		...
		<nav class="navbar navbar-expand">
			...
			{{-- <div class="search-bar flex-grow-1">
				<div class="position-relative search-bar-box">
					<input type="text" class="form-control search-control" placeholder="{{ __('mainNav.search') }}"> <span class="position-absolute top-50 search-show translate-middle-y"><i class='bx bx-search'></i></span>
	...
	<div class="top-menu ms-auto">
		<ul class="navbar-nav align-items-center">
			...
			<li class="nav-item dropdown dropdown">
				<a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown" aria-expanded="false"> <i class='bx bx-globe'></i>
				</a>
