									...
									<div class="form-body">
										...
										<form class="row g-3" method="POST" action="{{ route('register') }}">
											...
											<div class="col-12">
												...
												<x-input id="password" class="form-control border-end-0" type="password" name="password" required autocomplete="new-password" />
											</div>
											<div class="col-12">
												<x-label for="password_confirmation" :value="__('Confirm Password')" class="form-label" />

												<x-input id="password_confirmation" class="form-control border-end-0" type="password" name="password_confirmation" />
											</div>
											<!--
											<div class="col-12">
