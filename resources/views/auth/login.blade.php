                ...
                <div class="col mx-auto">
                    ...
                    <a href="{{ route('lang.switch', $lang) }}">
                        ...
                        <div class="mb-4 text-center">
                            <img src="{{ asset('assets/images/epin-pay-logo.svg') }}" width="300" alt="" />
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="col-12">
                                                <x-label class="form-label" for="password" value="{{ __('auth.password') }}" />
                                                <x-input id="password" class="form-control border-end-0" type="password" name="password" required autocomplete="current-password" />
                                            </div>
                                            <div class="col-md-6">
