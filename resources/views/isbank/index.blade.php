...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">{{ __('isbank.mainTitle') }}</div>
                    ...
                    <div class="row modal-bottom" style="margin-right: 0; margin-left: 0;">
                        <div class="add-page col-6">
                            <div class="border border-1 border-top-0 p-2 rounded mb-2">
                                ...
                                <div>
                                    <b><label for="conversation" class="form-label">{{ __('isbank.conversation') }}
                                            :</label></b>
                                    <label for="conversationId" class="form-label" id="conversationId"></label><br>
                                    <b><label for="fullName" class="form-label">{{ __('isbank.fullName') }}
                                            :</label></b>
                                    <label for="fullName" class="form-label" id="fullName"></label><br>
                                    <b><label for="resultCode" class="form-label">{{ __('isbank.resultCode') }}
                                            :</label></b>
                                    <label for="resultCode" class="form-label" id="resultCode"></label><br>
                                    <b><label for="resultMessage" class="form-label">{{ __('isbank.resultMessage') }}
                                            :</label></b>
                                    <label for="resultMessage" id="resultMessage" class="form-label"></label><br>
                                    <b><label for="merchant" class="form-label">{{ __('isbank.merchant') }}
                                            :</label></b>
                                    <label for="merchant" class="form-label" id="merchant"></label><br>
                                    <b><label for="orderId" class="form-label">{{ __('isbank.orderId') }}
                                            :</label></b>
                                    <label for="orderId" class="form-label" id="orderId"></label><br>
                                    <b><label for="totalAmount" class="form-label">{{ __('isbank.totalAmount') }}
                                            :</label></b>
                                    <label for="totalAmount" class="form-label" id="totalAmount"></label><br>
                                    <b><label for="transactionDateTime" class="form-label">{{ __('isbank.transactionDateTime') }}
                                            :</label></b>
                        ...
                        <div class="col-lg-6 border border-1 border-top-0 p-2  rounded mb-2">
                            <div class="mb-2">
                                <b> {{ __('isbank.paymentDetail') }}</b>
                                <hr>
                            </div>
                            <b><label for="paymentDetailPaymentType" class="form-label">{{ __('isbank.paymentType') }}
                                    :</label></b>
                            <label for="paymentDetailPaymentType" id="paymentDetailPaymentType" class="form-label"></label><br>
                            <b><label for="paymentDetailPaymentMethod" class="form-label">{{ __('isbank.paymentDetailPaymentMethod') }}
                                    :</label></b>
                            <label for="paymentDetailPaymentMethod" id="paymentDetailPaymentMethod" class="form-label"></label><br>
                            <b><label for="paymentDetailAccountNo" class="form-label">{{ __('isbank.paymentDetailAccountNo') }} :</label></b>
                            <label for="paymentDetailAccountNo" id="paymentDetailAccountNo" class="form-label"></label><br>
                            <b><label for="paymentDetailValorDate" class="form-label">{{ __('isbank.paymentDetailValorDate') }}
                                    :</label></b>
                            <label for="paymentDetailValorDate" id="paymentDetailValorDate" class="form-label"></label><br>
                            <b><label for="paymentDetailPaymentStatus" class="form-label">{{ __('isbank.paymentDetailPaymentStatus') }}
                                    :</label></b>
                            <label for="paymentDetailPaymentStatus" id="paymentDetailPaymentStatus" class="form-label"></label><br>
                            <b><label for="productDetailProductType" class="form-label">{{ __('isbank.productDetailProductType') }}
                                    :</label></b>
                            <label for="productDetailProductType" id="productDetailProductType" class="form-label"></label><br>
                            <b><label for="productDetailProductCategory" class="form-label">{{ __('isbank.productDetailProductCategory') }}
                                    :</label></b>
                            <label for="productDetailProductCategory" id="productDetailProductCategory" class="form-label"></label><br>
                            <b><label for="productDetailProductName" class="form-label">{{ __('isbank.productDetailProductName') }}
                                    :</label></b>
                            <label for="productDetailProductName" id="productDetailProductName" class="form-label"></label><br>

                            <b><label for="productDetailProductQuantity" class="form-label">{{ __('isbank.productDetailProductQuantity') }}
                                    :</label></b>
                            <label for="productDetailProductQuantity" id="productDetailProductQuantity" class="form-label"></label><br>

                            <b><label for="productDetailProductAmount" class="form-label">{{ __('isbank.productDetailProductAmount') }}
                                    :</label></b>
...
<script>
    $('body').on('click', '.showD', function(event) {
        ...
        var id = $(this).data('id');
        $.get("{{ route('isbank.index') }}" + '/' + id, function(data) {
            $('#modal-id').modal('show');
            $('#id').text(data.id);
