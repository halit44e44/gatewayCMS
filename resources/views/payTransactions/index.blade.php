...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">{{ __('payTransaction.mainTitle') }}</div>

            {{-- <audio controls id="music" class="inv">
                    <source src="panel-bildirim.mp3" type="audio/mpeg">
                </audio> --}}
